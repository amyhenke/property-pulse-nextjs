...
const BookmarkButton = ({ property }) => {
    // check if user is logged in - since using a client component, we don't use our utility to get the session user but rather import useSession
    ...
    useEffect(() => {
        ...
        // reruns whenever those variables change
