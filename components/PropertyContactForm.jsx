...
const PropertyContactForm = ({ property }) => {
    ...
    // first param uses addMessage action
    // second param is initial state
    const [state, formAction] = useActionState(addMessage, {})

    useEffect(() => {
        // in addMessage action can return an error is trying to send message about own property
    ...
    // if session is valid (logged in), then show the form to send message
    return (
        session && (
            <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <form action={formAction}>
                    ...
                    <div className="mb-4">
                        ...
                        <textarea className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 h-44 focus:outline-none focus:shadow-outline" id="body" name="body" placeholder="Enter your message"></textarea>
                    </div>
                    <div>
                        <SubmitMessageButton />
                    </div>
